import traceback
from redisBhavCopy import get_redis_connection
from parseBhavcopy import EqBhavCopyParser
...
class EqBhavCopyController():
    ...
    def get_stock_by_name(self,name):
        ...
        try:
            ...
            traceback.print_exc()
            res["data"] = "Something went wrong, Kindly try again.2222"
        return res
    ...
    def get_latest_stocks(self):
        ...
        try:
            ...
            traceback.print_exc()
            res["data"] = "Error fetching data. Please try again!"
        return res
