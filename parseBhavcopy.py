import redis
from redisBhavCopy import get_redis_connection, BHAV_COPY_URL
import traceback
import zipfile
import requests
import io
...
class EqBhavCopyParser():
    ...
    def get_zip_url(self):
        try:
            ...
            traceback.print_exc()
            res = {"status": 0, "data": "Error fetching data. Please try again!"}
            return res
    ...
    def extract_csv_file(self,zip_url):
        ...
        try:
            ...
            traceback.print_exc()
            res = {"status": 0, "data": "Something went wrong, Kindly try again.parser333"}
            return res
    ...
    def load_zip_to_redis(self):
        ...
        try:
            ...
            traceback.print_exc()
            res["data"] = "Something went wrong, Kindly try again.parser444"
        return res
